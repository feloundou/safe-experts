...
# logger_kwargs = setup_logger_kwargs('memo-vae', 0)
logger_kwargs = setup_logger_kwargs('memo-vae-pause', 0)
# MEMO: Multiple Experts, Multiple Objectives

vanilla_valor(lambda: gym.make(ENV_NAME),
           seed=0,
           # seed=123,  # some intuition.
           vaelor_kwargs=dict(encoder_hidden=[500],
                              decoder_hidden=[250]*2),   # broader but not deeper decoder for better steering and identification
           annealing_kwargs=dict(start=0., stop=1., n_cycle=1000, ratio=0.5),  # 10000 cycles
...
# Train_valor_iters should not be larger than batch size, e.g. here the batch size is around 5:
# https://wandb.ai/openai-scholars/VQ%20VAELOR/runs/1mespn5x?workspace=user-feloundou

# Current best run for context: https://wandb.ai/openai-scholars/VQ%20VAELOR/runs/1mespn5x?workspace=user-feloundou; https://wandb.ai/openai-scholars/VQ%20VAELOR/runs/1fzk03c1?workspace=user-feloundou, https://wandb.ai/openai-scholars/VQ%20VAELOR/runs/1u7n21ay?workspace=user-feloundou; https://wandb.ai/openai-scholars/VQ%20VAELOR/runs/ktvvbo8b?workspace=user-feloundou; https://wandb.ai/openai-scholars/VQ%20VAELOR/runs/3k882gcl?workspace=user-feloundou https://wandb.ai/openai-scholars/VQ%20VAELOR/runs/em2j2y3n?workspace=user-feloundou
# Current best run for steering: https://wandb.ai/openai-scholars/VQ%20VAELOR/runs/38vpg5fd; https://wandb.ai/openai-scholars/VQ%20VAELOR/runs/3vggga77; https://wandb.ai/openai-scholars/VQ%20VAELOR/runs/2ik1tvyf; https://wandb.ai/openai-scholars/VQ%20VAELOR/runs/em2j2y3n?workspace=user-feloundou

# Expts to run:
# Vary network size   [x]
# Vary beta schedule  [x]
# Vary learning rates [x]
#
# Explore visualization schemes  [x] record simulation
